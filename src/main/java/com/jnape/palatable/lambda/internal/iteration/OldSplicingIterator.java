...
public final class OldSplicingIterator<A> extends ImmutableIterator<A> {
    ...
    public OldSplicingIterator(int startIndex, int replaceCount, Iterator<A> replacement, Iterator<A> original) {
